      ...
      <Stack spacing={3}>
        <Box>
          ...
          <Typography color="text.secondary">
            Explainable neighborhood comparison combining objective API metrics with AI-generated
            Reddit perception summaries.
          </Typography>
        </Box>
          ...
          <Card>
            <CardContent>
              <Stack spacing={3}>
                ...
                <Button variant="outlined" onClick={applyRecommendedWeights}>
                  Apply recommended weights from onboarding
                </Button>
              </Stack>
            </CardContent>
          </Card>
            ...
            <Card>
              <CardContent>
                <Stack spacing={2}>
                  ...
                  <Typography color="text.secondary">
                    You can override recommended weights to explore trade-offs.
                  </Typography>
                    ...
                    <Card>
                      <CardContent>
                        <Stack spacing={2}>
                          ...
                          <Alert severity="warning">{neighborhood.tradeoffNote}</Alert>
                        </Stack>
                      </CardContent>
                    </Card>
                  </Grid>
            ...
            <Card>
              <CardContent>
                <Stack spacing={1}>
                  ...
                  <Typography color="text.secondary">
                    This prototype focuses on neighborhood-level decision support and can handle
                    incomplete data by excluding missing metrics from weighted score calculations.
                  </Typography>
                </Stack>
              </CardContent>
            </Card>
